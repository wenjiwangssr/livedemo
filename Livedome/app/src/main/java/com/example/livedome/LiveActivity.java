...
import com.example.livedome.bean.LiveChatBean;
import com.example.livedome.bean.LiveDanMuBean;
import com.example.livedome.bean.LiveEnterRoomBean;
import com.example.livedome.bean.LiveUserGiftBean;
...
import com.example.livedome.interfaces.SocketMessageListener;
import com.example.livedome.socket.SocketChatUtil;
import com.example.livedome.socket.SocketClient;
import com.example.livedome.utils.KeyBoardHeightUtil;
...
import com.example.livedome.views.AbsLiveViewHolder;
...
public abstract class LiveActivity extends AbsActivity implements SocketMessageListener {
...
//        ImMessageUtil.getInstance().loginJmessageAgain(uid);
//    }
//    /**
//     * 打开私信列表窗口
//     */
...
//        if (AppConfig.LIVE_ROOM_SCROLL && !mIsAnchor) {
