...
import com.example.livedome.bean.LiveBean;
import com.example.livedome.bean.UserBean;
import com.example.livedome.beauty.BeautyViewHolder;
import com.example.livedome.beauty.DefaultBeautyViewHolder;
import com.example.livedome.beauty.LiveBeautyViewHolder;
import com.example.livedome.dialog.LiveFunctionDialogFragment;
...
import com.example.livedome.interfaces.LivePushListener;
import com.example.livedome.music.LiveMusicDialogFragment;
import com.example.livedome.socket.SocketClient;
...
import com.example.livedome.views.AbsLivePushViewHolder;
import com.example.livedome.views.LiveAnchorViewHolder;
import com.example.livedome.views.LiveEndViewHolder;
import com.example.livedome.views.LiveKsyPushViewHolder;
import com.example.livedome.views.LiveMusicViewHolder;
import com.example.livedome.views.LiveReadyViewHolder;
import com.example.livedome.views.LiveRoomViewHolder;
...
//    }
    ...
    public void startLiveSuccess(String data, int liveType, int liveTypeVal) {
        ...
        if (mLiveRoomViewHolder == null) {
            mLiveRoomViewHolder = new LiveRoomViewHolder(mContext, mContainer);
