...
public class Constants {
    ...
    public static final String VOTES = "票票";
    ...
    public static final String VIDEO_SAVE_SAVE_AND_PUB = "1";//保存并发布
    public static final String VIDEO_SAVE_SAVE = "2";//仅保存
    public static final String VIDEO_SAVE_PUB = "3";//仅发布
