...
public class LiveKsyPushViewHolder extends AbsLivePushViewHolder implements
    ...
    public void init() {
        ...
        mStreamer.setEnableAudioPreview(false);//打开耳返效果
        mStreamer.setEnableAudioMix(false);//开启背景音乐的混音
