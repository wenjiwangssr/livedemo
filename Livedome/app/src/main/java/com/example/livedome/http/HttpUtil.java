...
import com.example.livedome.utils.MD5Util;
...
//    }
    ...
    public static void getConfig(final CommonCallback<ConfigBean> commonCallback) {
        HttpClient.getInstance().post("Home.getConfig", HttpConsts.GET_CONFIG)
...
//        HttpClient.getInstance().post("User.getBaseInfo", HttpConsts.GET_BASE_INFO)
...
//        HttpClient.getInstance().post("Login.userLogin", HttpConsts.LOGIN)
...
//                .params("lng", appConfig.getLng())
    ...
    public static void enterRoom(String liveUid, String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Live.enterRoom", HttpConsts.ENTER_ROOM)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
...
//    }
    ...
    public static void getHomeVideoList(int p, HttpCallback callback) {
        HttpClient.getInstance().post("Video.getVideoList", HttpConsts.GET_HOME_VIDEO_LIST)
                .params("uid", AppConfig.getInstance().getUid())
                .params("p", p)
                .execute(callback);
    }
    ...
    public static void getQiNiuToken(HttpCallback callback) {
        HttpClient.getInstance().post("Video.getQiniuToken", HttpConsts.GET_QI_NIU_TOKEN)
                .execute(callback);
    }
